...
export default function ProductForm({ product, cancelEdit }: Props) {
    ...
    const { brands, colors, categories } = useProducts();
        ...
        <Box component={Paper} sx={{ p: 4 }}>
            ...
            <form onSubmit={handleSubmit(handleSubmitData)}>
                <Grid container spacing={3}>  
                    ...
                    <Grid item xs={12} sm={6}>
                        <AppSelectList items={colors} control={control} name='color' label='Color' />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <AppSelectList items={categories} control={control} name='category' label='Category' />
                    </Grid>
                    <Grid item xs={12} sm={6}>
