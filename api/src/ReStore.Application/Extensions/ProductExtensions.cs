...
public static class ProductExtensions
{
     ...
     public static IQueryable<Product> Filter(this IQueryable<Product> query, string? brands, string? colors, string? categories)
     {
          ...
          query = query.Where(p => colorList.Count == 0 || colorList.Contains(p.Color.ToLower()));
